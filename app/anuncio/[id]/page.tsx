...
export default function AnuncioPage() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50">
        ...
        <p className="mt-4 text-gray-500 font-medium">Cargando detalles...</p>
      </div>
    )
  }
  ...
  if (!ad) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 text-center px-4">
        ...
        <h1 className="text-3xl font-bold mb-2">Anuncio no encontrado</h1>
        <p className="text-gray-500 mb-8">Parece que este anuncio fue eliminado o no existe.</p>
  ...
  const sellerPhone = ad.perfiles?.telefono?.replace(/\D/g, '') || "18290000000" // Default format for DR if not provided
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans text-gray-900 pb-20">
      ...
      <main className="max-w-5xl mx-auto px-4 md:px-8 py-8 md:py-12">
        <Link href={`/categoria/${ad.categorias?.nombre?.toLowerCase() || ''}`} className="text-sm font-bold text-blue-600 hover:text-blue-800 mb-6 inline-block transition-colors">
          ← Volver a {ad.categorias?.nombre || 'Categorías'}
        </Link>
            ...
            <div className="bg-white p-6 md:p-8 rounded-3xl shadow-xl border border-gray-100 sticky top-28">
              ...
              {!esConectar ? (
                ...
                <div className="mt-6 mb-8 bg-pink-50 p-5 rounded-2xl border border-pink-100">
                  ...
                  <div className="flex items-center gap-2 text-gray-500 text-xs font-medium mt-4 justify-center">
